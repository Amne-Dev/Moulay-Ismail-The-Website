...
async function migrateData() {
  ...
  try {
    ...
    console.log(`🗑️  Cleared ${existingLessons.deletedCount} existing lessons`);
    
    let totalInserted = 0;
    
    // Migrate each subject
    for (const [subject, lessons] of Object.entries(lessonsData)) {
      console.log(`\n📚 Migrating ${subject} lessons...`);
      ...
      console.log(`✅ Migrated ${lessons.length} ${subject} lessons`);
    }
    
    console.log(`\n🎉 Migration completed! Total lessons migrated: ${totalInserted}`);
